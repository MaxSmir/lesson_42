...
public:
    ...
    bool Init()
    {
        ...
        m_pGroundTex = new Texture(GL_TEXTURE_2D, "C:/Users/sofya/source/repos/lr5 IikG/lesson 33/Content/test.png");

        if (!m_pGroundTex->Load()) {
            return false;
        }

        if (!m_mesh.LoadMesh("C:/Users/sofya/source/repos/lr5 IikG/lesson 33/Content/phoenix_ugv.md2")) {
            return false;
        }
