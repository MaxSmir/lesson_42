...
bool LightingTechnique::Init()
{
    ...
    if (!AddShader(GL_VERTEX_SHADER, "C:/Users/sofya/source/repos/lr6 IiKG/lesson 42/lesson 42/shaders/lighting.vs")) {
        return false;
    }

    if (!AddShader(GL_FRAGMENT_SHADER, "C:/Users/sofya/source/repos/lr6 IiKG/lesson 42/lesson 42/shaders/lighting.fs")) {
        return false;
    }
